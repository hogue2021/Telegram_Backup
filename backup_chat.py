...
#OBTIENE ARCHIVO DE TEXTO CON GRUPOS
with open("listagrupos.txt") as f:
    lista_grupos = f.read().splitlines() 
...
object_name_in_gcs_bucket = bucket.blob(f'uruguay_pajaritos/miembros-{target_group.id}.csv')
